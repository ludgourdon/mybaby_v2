 ...
 */
final class Version20191017201735 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE account ADD email VARCHAR(180) NOT NULL');
        $this->addSql('ALTER TABLE account ADD roles JSON NOT NULL');
